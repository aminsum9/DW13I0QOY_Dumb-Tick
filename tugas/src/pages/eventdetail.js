        ...
        >
          ...
          {token == null && (
            <Button
              ...
              className="button-buy"
              style={{ marginBottom: "20px", marginLeft: "10px" }}
              onClick={() => alert("you must login to buy the ticket!")}
            >
              BUY
            </Button>
          )}
            ...
            >
              ...
              >
                ...
                <p>
                  ...
                  {data.startTime ? data.endTime.slice(0, 10) : ""}
                </p>
              </div>
              <div
                style={{
              ...
              >
                ...
                <p>
                  {"  "}
                  {data.startTime ? data.startTime.slice(11, 19) : ""} -{" "}
                  {data.startTime ? data.endTime.slice(11, 19) : ""}
                </p>
              </div>
            </div>
